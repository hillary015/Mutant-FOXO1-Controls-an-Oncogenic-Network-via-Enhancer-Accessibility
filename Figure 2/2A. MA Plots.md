...
```{r}
siggenes_LY7_FOXO1_0hrv6hr_geneexp_diff_tp_thres <- LY7_FOXO1_0hrv6hr_geneexp_diff %>% 
  mutate(timepoint = "6") %>%
  filter(status == "OK") %>%
  ...
  write_delim("20230510_LY7_FOXO1_RS_allxprs_thresh_0v6.txt", delim = "\t")

siggenes_LY7_FOXO1_0hrv24hr_geneexp_diff_tp_thres <- LY7_FOXO1_0hrv24hr_geneexp_diff %>% 
  mutate(timepoint = "24") %>%
  filter(status == "OK") %>%
  filter(is.finite(log2.fold_change.)) %>%
  mutate(threshold = case_when(p_value >= 0.05 ~ "zNS", log2.fold_change. > -0.585 & log2.fold_change. < 0.585 ~ "zNS", p_value < 0.05 & log2.fold_change. > 0.585 ~ "Up", p_value < 0.05 & log2.fold_change. < -0.585 ~ "Down")) %>%
  write_delim("20230510_LY7_FOXO1_RS_allxprs_thresh_0v24.txt", delim = "\t")
...
threshcount_LY7_0v6_mRNA <- threshcount(siggenes_LY7_FOXO1_0hrv6hr_geneexp_diff_tp_thres)
print(threshcount_LY7_0v6_mRNA)
threshcount_LY7_0v24_mRNA <- threshcount(siggenes_LY7_FOXO1_0hrv24hr_geneexp_diff_tp_thres)
print(threshcount_LY7_0v24_mRNA)
...
maplot_LY7_0v6 <- maplot(siggenes_LY7_FOXO1_0hrv6hr_geneexp_diff_tp_thres, "LY7_FOXO1-FKBP 0v6", 6, 2)
maplot_LY7_0v6

maplot_LY7_0v24 <- maplot(siggenes_LY7_FOXO1_0hrv24hr_geneexp_diff_tp_thres, "LY7_FOXO1-FKBP 0v24", 6, 2)
maplot_LY7_0v24
...
makepng_6x5(maplot_LY7_0v6, "20230510 LY7-FOXO1__0v6_mRNA_MA_6x5.png")
dev.off()
makepng_6x5(maplot_LY7_0v24, "20230510 LY7-FOXO1__0v24_mRNA_MA_6x5.png")
dev.off()
